...
It's a little complicated to explain the syntax, but you can use copy and paste this example to your own networ: just change the `main_name` to the correct column you wish to get the labels from in your own network. 
